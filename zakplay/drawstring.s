...
drawstringz_local_bd: ; start bc´ from destination base pointer
	ld bc, #0x1234 ; stored as self-modifying code
	exx
...
charloop:
	...
	add a, c ; a = width, c = pixel offset
	ld	b, a ; store new pixel offset in b temporarily

	ld	a, l
	or	a, a
	jr	Z, emptydata ; if glyph pattern is 0, skip drawing
	...
	bit 3, b
	jp Z, charloop ; if pixel offset goes over byte boundary, plot the second pixel too
...
emptydata:
	...
	jp  Z, charloop
	res 3, c ; new byte, keep pixel offset within it
	exx
